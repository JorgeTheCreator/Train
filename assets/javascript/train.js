...
// Initialize Firebase
 var config = {
    apiKey: "AIzaSyDGDadS4joRpoTQvmWyo4ZTvgPwjHjqKfc",
    authDomain: "train-6902e.firebaseapp.com",
    databaseURL: "https://train-6902e.firebaseio.com",
    storageBucket: "train-6902e.appspot.com",
    messagingSenderId: "500699839413"
  };
 firebase.initializeApp(config);
  // create a variable for firebase.database().ref()
